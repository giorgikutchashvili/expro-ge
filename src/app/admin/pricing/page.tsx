...
import { SERVICE_VEHICLE_LABELS, CRANE_DURATION_LABELS, CraneDuration } from '@/lib/types';
import {
  Save,
  MapPin,
  RefreshCw,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          <button
            onClick={handleReset}
            className="flex items-center space-x-2 px-3 sm:px-4 py-2 border border-[#475569] text-slate-400 hover:bg-[#334155] rounded-lg transition-colors"
          >
